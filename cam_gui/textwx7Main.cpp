...
BEGIN_EVENT_TABLE(textwx7Dialog, wxDialog)
    EVT_CLOSE(textwx7Dialog::OnClose)
    EVT_BUTTON(idBtnQuit, textwx7Dialog::OnQuit)
    EVT_BUTTON(idBtnAbout, textwx7Dialog::OnAbout)
END_EVENT_TABLE()

textwx7Dialog::textwx7Dialog(wxDialog *dlg, const wxString &title)
...
textwx7Dialog::~textwx7Dialog()
{
}

void textwx7Dialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void textwx7Dialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void textwx7Dialog::OnAbout(wxCommandEvent &event)
{
